...
def load_data(name, dataroot='data', device='cuda:0', imgsize=64,
    ...
    print('Loading dataset {} ...'.format(name.upper()), flush=True)
    ...
    print('DONE Loading dataset {} ...'.format(name.upper()), flush=True)
    return dat
...
def create_data(name, data_path, device, imgsize, Ntrain, Ntest, n_mixtures, radius, std):
    if name == 'ring':
        ...
        emnist = torchvision.datasets.EMNIST(root=data_path, split='letters',
